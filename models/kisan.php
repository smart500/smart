...
/**
 * This is the model class for table "kisan".
 *
 * @property int $id
 ...
 */
class Kisan extends \yii\db\ActiveRecord
{
    /**
     * {@inheritdoc}
     */
    ...
    public function rules()
    {
        return [
            ...
            [['birth_date', 'joining_date', 'regi_date', 'tharav_date', 'tharav_no', 'retire_date'], 'string', 'max' => 50],
    ...
    {
        return $this->hasOne(FarmtypeFarmertype::className(), ['id' => 'farm_type_id']);
    }
